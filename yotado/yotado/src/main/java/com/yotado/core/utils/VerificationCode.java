...
public class VerificationCode {
    ...
    @Autowired
    static SystemProperty systemProperty;
    ...
    public static String generateVerifyCodeBufferedImage(String filePath, HttpServletResponse response)throws IOException{
        res = response;
    ...
    /*public static void main(String[] args) throws IOException{
        File dir = new File(systemProperty.getVerificationCodeDir());
        int w = 200, h = 80;
        String verifyCode = generateVerifyCode(4);
        File file = new File(dir, verifyCode + ".jpg");
        outputImage(w, h, file, verifyCode);
